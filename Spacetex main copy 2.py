...
if "check incoming signals" in mssgwdyd:
    ...
    if "respond to signal" in detection_options:
        ...
        if "follow coordinates" in path_a2a:
            ...
            print("you died ig")
elif "run system diagnostics" in mssgwdyd:
    print("The system reveals something shocking...")
    wait2sec
    print("There are missing memory sectors..")
    print("And corrupted human records..")
    print("HUH??? what is this?? it says operator identity mismatch.")
    b1 = input("Your move: [Restore backups | Delete corrupted files | Inspect operator file]").lower()
    if "restore backups" in b1:
        print("You restore older system versions...")
        wait3sec 
        print("But the past logs contradict the current reality")
        print("The world around you starts warping... dark spots are forming and you are forgetting..")
        time.sleep(5)
        print("The timeline is becoming unstable")
    elif "delete corrupted files" in b1:
        print("You remove the corrupted data...")
        wait3sec
        print("YOU ACCIDENTALLY DELETE YOUR OWN IDENTITY FILE")
        print("Don worry the self awareness crisis route is coming but for now:")
        print("\n")
        print("  ▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓")
        print("  ▓                                    ▓")
        print("  ▓           † YOU DIED †             ▓")
